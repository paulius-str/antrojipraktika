...
namespace API.Data.Migrations
{
    ...
    [Migration("20220109170917_GradeRefChanged")]
    partial class GradeRefChanged
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.AssignedLecturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("API.Entities.AssignedLecturer", b =>
                {
                    b.HasOne("API.Entities.Lecturer", "Lecturer")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Entities.Grade", b =>
                {
                    ...
                    b.HasOne("API.Entities.Assignment", "Subject")
                        .WithMany()
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
